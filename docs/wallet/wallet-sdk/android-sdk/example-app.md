...
#### **_Initiate Privado ID SDK_**

To start using Privado ID SDK, an integrator needs to initialize it first. This is done by using:
...
This part of the flow consists of initialising Privado ID SDK, creating an identifier for an identity and retrieving it, and using the identifier to authenticate the Identity.
